//! Verify the FP8 E4M3 + UE8M0-scale dequantizer against a known V4F
//! tensor. Cross-checked against a stdlib-Python reference that read
//! the same bytes.
//!
//! Usage:
//!   cargo run --release --example v4f_dequant_check
//!
//! Hardcodes the path to the local V4F snapshot. Prints the first 16
