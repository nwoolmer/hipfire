...
fn load_weight_tensor(hfq: &HfqFile, gpu: &Gpu, st_name: &str, m: usize, k: usize) -> HipResult<WeightTensor> {
    ...
    match info.quant_type {
        ...
        30 => { // HFP4G32 — E2M1 + UE8M0 g32 + FP16 row scale.
                ...
                // Note: original upstream qtype was 21; renumbered to 30 to avoid
                // collision with HFQ1G128 (reserved at 21 on this branch). Update
                // any externally-quantized HFP4 .hfq files accordingly.
        ...
        33 => { // MFP4G32 — HFP4G32 + offline FWHT rotation (drop-in MQ4 replacement).
                // Same byte layout as qtype 30; format_flags=0x05 in row hdr.
                // See docs/quant-formats/hfp4.md.
                // Note: original upstream qtype was 24; renumbered to 33 (see HFP4G32 note).
